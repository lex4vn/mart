<ul id="menu">
  ...
  <li><a href="<?php echo $news; ?>"><i class="fa fa-info-circle fa-fw"></i> <span><?php echo $text_news; ?></span></a></li>
  <li><a href="<?php echo $interface; ?>"><i class="fa fa-television fa-fw"></i> <span><?php echo $text_interface; ?></span></a></li>
  ...
  <li id="design"><a href="<?php echo $layout; ?>"><i class="fa fa-television fa-fw"></i> <span><?php echo $text_design; ?></span></a></li>
  ...
  <li><a class="parent"><i class="fa fa-user-secret fa-fw"></i> <span><?php echo $text_users; ?></span></a>
      <ul>
