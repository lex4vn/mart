...
public final class AddText implements TextOption {
    ...
    public AddText(String text, String signFilterOption, String signText, boolean isBefore) {
        ...
        this.signFilter = StringFilterFactory.getFilter(FilterOption.parse(this.signFilterOption), this.signText);
    }
    ...
    public String toString() {
        return "AddText [addingText=" + this.addingText + ", signText=" + this.signText + ", signFilterOption="
            + this.signFilterOption + ", isBefore=" + this.isBefore + "]";
    }
